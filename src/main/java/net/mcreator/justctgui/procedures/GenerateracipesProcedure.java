...
public class GenerateracipesProcedure {
	public static void execute(LevelAccessor world, HashMap guistate) {
		...
		if (("").equals(guistate.containsKey("text:recipe_name") ? ((EditBox) guistate.get("text:recipe_name")).getValue() : "") && !JustCtguiModVariables.Is_shapeless && !JustCtguiModVariables.Is_mirrored) {
		...
		} else if (("").equals(guistate.containsKey("text:recipe_name") ? ((EditBox) guistate.get("text:recipe_name")).getValue() : "") && JustCtguiModVariables.Is_shapeless) {
		...
		} else if (("").equals(guistate.containsKey("text:recipe_name") ? ((EditBox) guistate.get("text:recipe_name")).getValue() : "") && JustCtguiModVariables.Is_mirrored) {
