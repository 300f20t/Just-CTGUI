...
public class CraftingTableRemovingCTGUIScreen extends ContainerScreen<CraftingTableRemovingCTGUIMenu> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack poseStack, int mouseX, int mouseY) {
		this.font.drawString(poseStack, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.label_file_name").getString(), -129, -2, -3355393);
		this.font.drawString(poseStack, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.label_crafting").getString(), 42, 7, -12829636);
	}

	@Override
	public void init(Minecraft minecraft, int width, int height) {
		super.init(minecraft, width, height);
		file_name = new TextFieldWidget(this.font, this.guiLeft + -128, this.guiTop + 8, 118, 18, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.file_name")) {
			@Override
			public void writeText(String text) {
				super.writeText(text);
				if (getText().isEmpty())
					setSuggestion(new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.file_name").getString());
				else
					setSuggestion(null);
			}
		...
		file_name.setSuggestion(new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.file_name").getString());
		file_name.setMaxStringLength(32767);
		guistate.put("text:file_name", file_name);
		this.children.add(this.file_name);
		button_generate = new Button(this.guiLeft + 186, this.guiTop + 7, 67, 20, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.button_generate"), e -> {
			if (true) {
		...
		button_save = new Button(this.guiLeft + 186, this.guiTop + 34, 46, 20, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.button_save"), e -> {
			if (true) {
		...
		button_close = new Button(this.guiLeft + 186, this.guiTop + 142, 51, 20, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.button_close"), e -> {
			if (true) {
		...
		button_reload = new Button(this.guiLeft + 186, this.guiTop + 61, 56, 20, new TranslationTextComponent("gui.just_ctgui.crafting_table_removing_ctgui.button_reload"), e -> {
			if (true) {
