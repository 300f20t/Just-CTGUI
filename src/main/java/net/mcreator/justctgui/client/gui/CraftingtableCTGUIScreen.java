...
public class CraftingtableCTGUIScreen extends AbstractContainerScreen<CraftingtableCTGUIMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (ATTENTIONProcedure.execute()) {
			guiGraphics.blit(new ResourceLocation("just_ctgui:textures/screens/popup_hint.png"), this.leftPos + -117, this.topPos + 133, 0, 0, 16, 16, 16, 16);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.craftingtable_ctgui.label_recipe_name"), -123, -3, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.craftingtable_ctgui.label_file_name"), -123, 33, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.craftingtable_ctgui.label_empty"), -119, -39, -4610825, false);
	}
	...
	public void init() {
		...
		button_all = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_all"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_0"), new CraftingtableCTGUIButtonMessage(0, x, y, z));
			}
		...
		button_diagonal = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_diagonal"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_1"), new CraftingtableCTGUIButtonMessage(1, x, y, z));
			}
		...
		button_horizontal = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_horizontal"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_2"), new CraftingtableCTGUIButtonMessage(2, x, y, z));
			}
		...
		button_none = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_none"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_3"), new CraftingtableCTGUIButtonMessage(3, x, y, z));
			}
		...
		button_vertical = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_vertical"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_4"), new CraftingtableCTGUIButtonMessage(4, x, y, z));
			}
		...
		button_generate = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_generate"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_5"), new CraftingtableCTGUIButtonMessage(5, x, y, z));
			}
		...
		button_save = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_save"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_6"), new CraftingtableCTGUIButtonMessage(6, x, y, z));
			}
		...
		button_close = Button.builder(Component.translatable("gui.just_ctgui.craftingtable_ctgui.button_close"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(JustCtguiMod.MODID, "craftingtablectgui_button_7"), new CraftingtableCTGUIButtonMessage(7, x, y, z));
			}
